        ...
        try {
            ...
            if (res.success && res.data.history.length > 0) {
                ...
                setMessages([
                    {
                        sender: 'ai',
                        text: 'Hello! I am your ExpenseIQ Pro AI Financial Assistant. Ask me anything about your spending, savings, budget, or future predictions!'
                    }
                ]);
            }
        } catch (err) {
                ...
                <div className="modal-content border-0 shadow-lg rounded-3">
                    <div className="modal-header bg-primary text-white py-3 px-4 rounded-top-3">
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <h5 className="modal-title fw-bold mb-0">ExpenseIQ Pro AI Assistant</h5>
                        </div>
